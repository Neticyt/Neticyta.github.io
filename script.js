...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Quizas no pude quedarme contigo, pero si tuve el placer de haberte conocido y te extrañare de la manera más callada que pueda existir.';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy muy triste, Karen.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Hacer que el botón "Sí" crezca
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Vale, ya dejaré de preguntar Karen ...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'Es broma Karen, POR FAVOR DI SÍ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy muy muy triste Kareeen.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Hacer que el botón "Sí" crezca
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = 'Estás rompiendo mi corazón Karen en pedacitos :(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NO...Karen ya di que si anda no seas mala';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Hacer que el botón "Sí" crezca
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'Anda Karen Siiiiiiiiiiiiiiiiiiiiiiiiiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Hacer que el botón "Sí" crezca
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = ' Karen por favooooooor';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
